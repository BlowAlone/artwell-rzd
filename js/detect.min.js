    ...
    return (
      (e.parse = function(r) {
        ...
        (s.source = r),
          (s.browser = i(r, t)),
          l(s.browser)
            ? ((s.browser.name = d(s.browser)),
              (s.browser.version = c(s.browser)))
            : (s.browser = {}),
          (s.os = i(r, m)),
          l(s.os)
            ? ((s.os.name = d(s.os)), (s.os.version = c(s.os)))
            : (s.os = {}),
          (s.device = i(r, p)),
          l(s.device)
            ? ((s.device.name = d(s.device)), (s.device.version = c(s.device)))
